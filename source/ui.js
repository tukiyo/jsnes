    ...
    (function($) {
        $.fn.JSNESUI = function(roms) {
            ...
            var UI = function(nes) {
                 ...
                 */
                self.root = $('<div></div>');
                self.screen = $('<canvas class="nes-screen" width="256" height="240" style="image-rendering: pixelated;"></canvas>').appendTo(self.root);
                ...
                document.getElementsByClassName('nes-controls')[0].setAttribute('style', 'display:none;')
                /*
                 * ROM loading
                 */
